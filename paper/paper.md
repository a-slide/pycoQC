...
Briefly, pycoQC imports, filters and preprocesses a summary file generated by one of the previously mentioned basecallers or with the companion program `Fast5_to_seq_summary` provided with the package. Then, a range of plots and tables can be generated to explore the data (**Figure 1**)
