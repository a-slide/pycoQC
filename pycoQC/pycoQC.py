...
class pycoQC():
    ...
    #~~~~~~~FUNDAMENTAL METHODS~~~~~~~#
    def __init__ (self, seq_summary_file, run_type="", runid_list=[], filter_zero_len=False, filter_fail=False, verbose=False, **kwargs):
        """
    ...
    def overview (self):
        ...
        _ = sns.violinplot (data=df, y="run_id", x="mean_qscore", alpha=0.5, bw=.2, linewidth=1, inner="quartile",
            ax=ax1, palette="Set3")
        _ = ax1.set_title ("Quality score distribution")
        fig1.tight_layout()

        fig2, ax2 = pl.subplots (figsize=(12, n_runid/2+1))
        _ = sns.violinplot (data=df, y="run_id", x="num_bases", alpha=0.5, bw=.2, cut=0, linewidth=1, inner="quartile",
            ax=ax2, palette="Set3")
