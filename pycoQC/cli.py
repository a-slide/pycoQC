...
from pycoQC import __description__ as package_description
...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(description = package_description, add_help=False)
    ...
    parser.add_argument("--config", "-c", type=str, default=None,
        ...
        If it's still not found, falls back to default parameters.
    ...
    group.add_argument("--default_config", "-d",  action='store_true',
        help="Print default configuration file. Can be used to generate a template JSON file")
